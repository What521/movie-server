...
let movies = [
  {
    ...
    cast: "Keanu Reeves, Adrianne Palicki",
    year: "2014",
    rating: "7.4/10 IMDb"
},
{
...
},
{
    ...
    cast: "Mark Wahlberg, Michelle Dockery",
    year: "2025",
    rating: "5.3/10 IMDb"
},
{
...
},
{
    ...
    cast: "Channing Tatum, Scarlett Johanessen",
    year: "2024",
    rating: "6.6/10 IMDb"
},
{
...
app.put("/api/movies/:id", upload.single("img"),(req,res)=>{
    const movie = movies.find((movie)=>movie.be_id===parseInt(req.params.id));

    if(!movie){
        res.status(404).send("The movie with the provided id was not found");
        return;
    }
...
app.delete("/api/movies/:id",(req,res)=>{
    ...
    console.log("The movie you are deleting is " + movie.name);
